...
-   Are there any sources of *erroneous* uncertainty in the percent occupied you calculated?
    -   No, I re-counted and double checked at the same time with another student looking at the same population. The only error could have occurred if I had miscounted a home when going though the islands page.
