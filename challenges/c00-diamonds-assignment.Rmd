...
- The price of the diamond general increases with the cost; however there is some spread along the data so it isn't exactly related in that way.
...
- When the cut of the diamond is more ideal it is generally the more expensive. As the carat increases and the cost increases there is a slight trend in the cut becoming more ideal. However, there is still spread on this and it is not a direct relationship. 
